...
% Helper command for scene types
\makeatletter % Needed for @ in command name
\newcommand{\@sceneHelper}[2]{\textbf{#1}\ifthenelse{\isempty{#2}}{}{ (#2)}}
\makeatother

% Redefined commands using the helper
\newcommand{\cs}[1][]{\@sceneHelper{CS}{#1}}
\newcommand{\skippablecs}[1][]{\@sceneHelper{Skippable CS}{#1}}
\newcommand{\fmv}[1][]{\@sceneHelper{FMV}{#1}}
\newcommand{\skippablefmv}[1][]{\@sceneHelper{Skippable FMV}{#1}}
...
% New commands for common battle actions
% Usage: \Attack{tidus}, \Defend{auron}, etc.
\newcommand{\Attack}[1]{{\csname #1f\endcsname} Attack}
\newcommand{\Defend}[1]{{\csname #1f\endcsname} Defend}
...
% Define the generalized helper command
% Args: {result_to_check ('win', 'loss', 'both')}{layout_command (\newline, \vfill, etc.)}{apply_in_single_col (true/false)}
\newcommand{\layoutConditional}[3]{%
  \ifthenelse{\equal{\colstyle}{multi}}{% Multi-column behavior
      \ifthenelse{\equal{\blitzresult}{#1}}{#2}{}% Apply if blitzresult matches
  }{% Single-column behavior
      \ifthenelse{\equal{#3}{true}}{% Check if it should apply in single-column
          \ifthenelse{\equal{\blitzresult}{#1}}{#2}{}% Apply if blitzresult matches
      }{}% Do nothing if apply_in_single_col is false
  }%
}

% Define commands using the new helper (passing 'false' for apply_in_single_col)
\newcommand{\bothnewline}{\layoutConditional{both}{\newline}{false}}
\newcommand{\winnewline}{\layoutConditional{win}{\newline}{false}}
\newcommand{\lossnewline}{\layoutConditional{loss}{\newline}{false}}

\newcommand{\bothvfill}{\layoutConditional{both}{\vfill}{false}}
\newcommand{\winvfill}{\layoutConditional{win}{\vfill}{false}}
\newcommand{\lossvfill}{\layoutConditional{loss}{\vfill}{false}}

\newcommand{\bothcb}{\layoutConditional{both}{\columnbreak}{false}}
\newcommand{\wincb}{\layoutConditional{win}{\columnbreak}{false}}
\newcommand{\losscb}{\layoutConditional{loss}{\columnbreak}{false}}

\newcommand{\bothnp}{\layoutConditional{both}{\newpage}{false}}
\newcommand{\winnp}{\layoutConditional{win}{\newpage}{false}}
\newcommand{\lossnp}{\layoutConditional{loss}{\newpage}{false}}

% Define single-column commands using the new helper (passing 'true' for apply_in_single_col)
\newcommand{\bothnpsingle}{\layoutConditional{both}{\newpage}{true}}
\newcommand{\winnpsingle}{\layoutConditional{win}{\newpage}{true}}
\newcommand{\lossnpsingle}{\layoutConditional{loss}{\newpage}{true}}
...
% Helper command for character sphere grid sections (header and items only)
% #1: Character command (e.g., tidus) - NOTE: lowercase, no backslash
% #2: S.Lvl info (e.g., (4 S.Lvl)) - can be empty
% #3: Inner itemize content (list of \item ...)
\newcommand{\characterSphereGrid}[3]{%
  {\csname #1f\endcsname} \ifthenelse{\isempty{#2}}{}{#2}% Character name and S.Lvl
  \begin{itemize}% Inner itemize for moves
    #3
  \end{itemize}
}
